...
#ifndef __ExampleFrameListener_hydrax_H__
#define __ExampleFrameListener_hydrax_H__
...
class ExampleFrameListenerHydrax: public FrameListener, public WindowEventListener
{
protected:
...
public:
	...
	ExampleFrameListenerHydrax(RenderWindow* win, Camera* cam, bool bufferedKeys = false, bool bufferedMouse = false,
	...
	virtual ~ExampleFrameListenerHydrax()
	{		
